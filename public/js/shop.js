...
const DailyItems=async()=>{
    ...
    const DailyShop = await fortniteAPI.getDailyShop();

    return DailyShop
}


DailyItems().then((result)=>{
...
var html=`<a class="fortnite-db-item fortnite-db-item--large-text fortnite-db-item--%rarity%" style="grid-column: span 1;" href="/details?id=%id%"  title="%title%"><img loading="lazy" class="fortnite-db-item__image" src="%img%" alt="fortnite shop item Whiteout" /><div class="fortnite-db-item__details"><div class="fortnite-db-item__name"><span >%name%</span></div><div class="fortnite-db-item__price"><img loading="lazy" src="https://cdn.thetrackernetwork.com/cdn/trackernetwork/3C7Avbucks.png" alt="1500 v-bucks" /><span >%price%</span></div></div><div class="fortnite-db-item__rating"><i class="ion ion-star" ></i> <span>%star%</span></div></a>`,
  ...
  document.querySelector('.daily-items').insertAdjacentHTML('beforeend', nwHtml);

    }
//add special daily items
result.daily=result.specialDaily
for(let i=0;i<=result.featured.length-1;i++)
    {
        if(!result.daily[i])
             break;
...
var html=`<a class="fortnite-db-item fortnite-db-item--large-text fortnite-db-item--%rarity%" style="grid-column: span 1;" href="/details?id=%id%"  title="%title%"><img loading="lazy" class="fortnite-db-item__image" src="%img%" alt="fortnite shop item Whiteout" /><div class="fortnite-db-item__details"><div class="fortnite-db-item__name"><span >%name%</span></div><div class="fortnite-db-item__price"><img loading="lazy" src="https://cdn.thetrackernetwork.com/cdn/trackernetwork/3C7Avbucks.png" alt="1500 v-bucks" /><span >%price%</span></div></div><div class="fortnite-db-item__rating"><i class="ion ion-star" ></i> <span>%star%</span></div></a>`,
  ...
  document.querySelector('.Sdaily-items').insertAdjacentHTML('beforeend', nwHtml);

    }

//add Featured items

console.log(result.featured[0])
 ...
 var  html=`<a class="fortnite-db-item fortnite-db-item--large-text fortnite-db-item--%rarity%" style="grid-column: span 1;" href="/details?id=%id%" id="%id%"><img loading="lazy" class="fortnite-db-item__image" src="%img%" alt="fortnite shop item" /><div class="fortnite-db-item__details"><div class="fortnite-db-item__name" >%name%</div><div class="fortnite-db-item__price"><img loading="lazy" src="https://cdn.thetrackernetwork.com/cdn/trackernetwork/3C7Avbucks.png" alt="2000 v-bucks" /> <span>%price%</span></div></div><div class="fortnite-db-item__rating"><i class="ion ion-star"></i> %star%</div></a>`;
  ...
  document.querySelector('.featured-items').insertAdjacentHTML('beforeend', newHtml);

    }

    // add special featured items
    result.featured=result.specialFeatured;
    console.log('special :',result.featured)
    for(let i=0;i<=result.featured.length-1;i++)
    {
        var border=result.featured[i].rarity==='uncommon'?'handmade':result.featured[i].rarity;
 ...
 var  html=`<a class="fortnite-db-item fortnite-db-item--large-text fortnite-db-item--%rarity%" style="grid-column: span 1;" href="/details?id=%id%" id="%id%"><img loading="lazy" class="fortnite-db-item__image" src="%img%" alt="fortnite shop item" /><div class="fortnite-db-item__details"><div class="fortnite-db-item__name" >%name%</div><div class="fortnite-db-item__price"><img loading="lazy" src="https://cdn.thetrackernetwork.com/cdn/trackernetwork/3C7Avbucks.png" alt="2000 v-bucks" /> <span>%price%</span></div></div><div class="fortnite-db-item__rating"><i class="ion ion-star"></i> %star%</div></a>`;
  ...
  document.querySelector('.Sfeatured-items').insertAdjacentHTML('beforeend', newHtml);
