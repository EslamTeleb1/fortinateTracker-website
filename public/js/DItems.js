...
.then((result)=>{
   ...
   result.json().then(result=>{
      ...
      {
         var html=` <article class="trn-card trn-article " itemscope="" itemtype="https://schema.org/Article"><div itemprop="publisher" itemscope="" itemtype="https://schema.org/Organization"><meta itemprop="name" content="The Tracker Network"><link itemprop="sameAs" href="https://thetrackernetwork.com" rel="publisher"><div itemprop="logo" itemscope="" itemtype="https://schema.org/ImageObject"><meta itemprop="url" content="https://cdn.thetrackernetwork.com/cdn/trackernetwork/EED7icon-120.png"></div></div><meta itemprop="headline" content="Fortnite will remain at 60 FPS on next-gen consoles"><meta itemprop="dateModified" content="11/2/2020 5:25:49 PM"><meta itemprop="mainEntityOfPage" content="https://fortnitetracker.com/article/1352/fortnite-will-remain-at-60-fps-on-next-gen-co"><div class="trn-article__hero trn-article__hero--image"><a href="/article/1352/fortnite-will-remain-at-60-fps-on-next-gen-co" itemprop="url"><img src=%image%></a></div><div class="trn-card__content"><h1 class="trn-article__title"><a href="/article/1352/fortnite-will-remain-at-60-fps-on-next-gen-co" itemprop="url">%title%</a></h1><div class="trn-article__details"><span class="trn-article__author" itemscope="" itemtype="https://schema.org/Person" itemprop="author"> <span itemprop="name">%author%</span>,</span><time class="trn-article__time" itemprop="datePublished" datetime="%date%">%date%</time></div><div class="trn-article__actions"> <a class="trn-button" href="/article/1352/fortnite-will-remain-at-60-fps-on-next-gen-co" itemprop="url">Read More</a><a class="trn-button trn-button--link" href="#" rel="noreferrer noopener"><i class="ion ion-social-twitter"></i> </a><a class="trn-button trn-button--link" href="#"  rel="noreferrer noopener"><i class="ion ion-social-facebook"></i></a><a class="trn-button trn-button--link" href="#"  rel="noreferrer noopener"><i class="ion ion-social-reddit"></i></a></div></div> </article> `
